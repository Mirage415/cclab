...
function displayText() {
  ...
  text(
    `You have saved ${found.length} trapped citizens！`,
    width / 2,
    height / 2
  );
}
...
function checkAndNavigate() {
  ...
  setTimeout(() => {
    ...
    window.location.href =
      "https://mirage415.github.io/cclab/final_project/codes/%E7%AC%AC%E4%BA%8C%E5%85%B3.html";
  }, 1000); // 等待1秒后执行页面跳转
}
